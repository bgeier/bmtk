...
mkgct(fullfile(otherwkdir,[pullname(arg.gct),'_ins_ratios.gct']),ins,gn,gd,ins_sid); 
mkgct(fullfile(otherwkdir,[pullname(arg.gct),'_ins_ranks.gct']),ins_ranks,gn,gd,ins_sid); 
