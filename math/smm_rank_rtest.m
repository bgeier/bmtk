...
[ge,gn,gd,sid] = parse_gct(arg.smm_ranks); 
...
mkgct(fullfile(arg.out,[pullname(arg.smm_ranks),'_rank',arg.type,'_pvalues.gct']),...
    cp_ranks_pvalues,gn,gd,classes); 
mkgct(fullfile(arg.out,[pullname(arg.smm_ranks),'_rank',arg.type,'_neglogpvalues.gct']),...
